...
#ifndef NEURAL_NETWORK_DETECTOR__MSG__NEURAL_NETWORK_DETECTION_ARRAY_H_
#define NEURAL_NETWORK_DETECTOR__MSG__NEURAL_NETWORK_DETECTION_ARRAY_H_
...
#endif  // NEURAL_NETWORK_DETECTOR__MSG__NEURAL_NETWORK_DETECTION_ARRAY_H_

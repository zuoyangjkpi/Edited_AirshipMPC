...
#include "neural_network_detector/msg/detail/neural_network_feedback__rosidl_typesupport_fastrtps_c.h"
...
using _NeuralNetworkFeedback__ros_msg_type = neural_network_detector__msg__NeuralNetworkFeedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NeuralNetworkFeedback__ros_msg_type * ros_message = static_cast<const _NeuralNetworkFeedback__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _NeuralNetworkFeedback__ros_msg_type * ros_message = static_cast<_NeuralNetworkFeedback__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_neural_network_detector__msg__NeuralNetworkFeedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NeuralNetworkFeedback__ros_msg_type * ros_message = static_cast<const _NeuralNetworkFeedback__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _NeuralNetworkFeedback__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_neural_network_detector__msg__NeuralNetworkFeedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_neural_network_detector
size_t max_serialized_size_neural_network_detector__msg__NeuralNetworkFeedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = neural_network_detector__msg__NeuralNetworkFeedback;
    is_plain =
      (
...
static size_t _NeuralNetworkFeedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_neural_network_detector__msg__NeuralNetworkFeedback(
...
static message_type_support_callbacks_t __callbacks_NeuralNetworkFeedback = {
...
static rosidl_message_type_support_t _NeuralNetworkFeedback__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NeuralNetworkFeedback,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neural_network_detector, msg, NeuralNetworkFeedback)() {
  return &_NeuralNetworkFeedback__type_support;
}

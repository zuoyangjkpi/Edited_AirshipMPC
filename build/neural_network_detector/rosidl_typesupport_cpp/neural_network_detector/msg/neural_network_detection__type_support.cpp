...
static const _NeuralNetworkDetection_type_support_symbol_names_t _NeuralNetworkDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, neural_network_detector, msg, NeuralNetworkDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, neural_network_detector, msg, NeuralNetworkDetection)),
  }
};
...
{
  return &::neural_network_detector::msg::rosidl_typesupport_cpp::NeuralNetworkDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, neural_network_detector, msg, NeuralNetworkDetection)() {
  return get_message_type_support_handle<neural_network_detector::msg::NeuralNetworkDetection>();
}
